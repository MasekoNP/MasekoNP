...
I enjoy working with tools such as R, Python (learning), SQL, Excel, Power BI, and Looker Studio to analyse data, build dashboards, and uncover trends that help businesses improve performance and make informed decisions.
